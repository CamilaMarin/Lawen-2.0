...
public class dominiosController {
    ...
    */
    ...
    public void init() {
        ...
        identificadoresControles= new ArrayList<>(24);
        identificadoresControles.add(0,"28 días");
        identificadoresControles.add(1,"1 mes");
        identificadoresControles.add(2,"2 meses");
        identificadoresControles.add(3,"3 meses");
        identificadoresControles.add(4,"4 meses");
        identificadoresControles.add(5,"5 meses");
        identificadoresControles.add(6,"6 meses");
        identificadoresControles.add(7,"7 meses");
        identificadoresControles.add(8,"8 meses");
        identificadoresControles.add(9,"10 meses");
        identificadoresControles.add(10,"1 año");
        identificadoresControles.add(11,"1 año 3 meses");
        identificadoresControles.add(12,"1 año 6 meses");
        identificadoresControles.add(13,"1 año 9 meses");
        identificadoresControles.add(14,"2 años");
        identificadoresControles.add(15,"2 años 6 meses");
        identificadoresControles.add(16,"3 años");
        identificadoresControles.add(17,"3 años 6 meses");
        identificadoresControles.add(18,"4 años");
        identificadoresControles.add(19,"5 años");
        identificadoresControles.add(20,"6 años");
        identificadoresControles.add(21,"7 años");
        identificadoresControles.add(22,"8 años");
        identificadoresControles.add(23,"9 años");
