...
public class CCVNutricionistaController implements Serializable {
     ...
     * @return 
     */
     public String crearCCV( CartolaSeguimientoCCVController cont, FichaNutricionistaController fich, PacienteController pac, int edad, boolean diabetico, boolean hipertenso, boolean dilipidemia, boolean ACV, boolean IAM,boolean prediabetes ){
