...
public class ControlNinoFacadeTest {
    ...
    public void setUp() throws ParseException {
        ...
        controles2.add(controlnino);
        controles2.add(controlnino1); 
        
        when(mockControlNinoFacade.findLastControl(cartolanino.getId())).thenReturn(controles1);
        when(mockControlNinoFacade.findbyCartola(cartolanino.getId())).thenReturn(controles2);
    }
    ...
    public void testFindLastControl() throws Exception {
            ...
            assertEquals(expControles1, mockControlNinoFacade.findLastControl(expCartola.getId()));
    }
